...
export default function Footer() {
  ...
  return (
    <footer style={{ 
      ...
      <div className="responsive-footer" style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "2rem" }}>
        <div className="responsive-text-center" style={{ maxWidth: "300px" }}>
        ...
        <div className="responsive-footer-links" style={{ display: "flex", gap: "4rem", flexWrap: "wrap" }}>
          <div className="responsive-footer" style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
      ...
      <div className="responsive-footer" style={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "2rem", marginTop: "1rem" }}>
